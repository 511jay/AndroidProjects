...
//각종 메소드 사용 시 필요로하는 안드로이드 스튜디오 지원 라이브러리들 입니다.
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        //안드로이드 스튜디오에서 제공하는 기본 포멧을 사용합니다
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);

        //버튼 인터페이스의 생성자입니다
        //메인에서 총 4개의 버튼을 사용합니다
        ...
        //아래의 3개의 버튼리스너는 클릭 시 Otion, ReservationList, State 액티비티로 이동하는 버튼입니다
