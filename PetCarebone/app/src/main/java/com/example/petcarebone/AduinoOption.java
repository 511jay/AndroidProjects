...
public class AduinoOption extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button OK_B = (Button)findViewById(R.id.OKB);
        ...
        OK_B.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final AlertDialog.Builder builder = new AlertDialog.Builder(AduinoOption.this);
                builder.setTitle("펫 정보 전송");
                builder.setMessage("펫정보를 전송하시겠습니까?");
                builder.setPositiveButton("예", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        AlertDialog.Builder builder2 = new AlertDialog.Builder(AduinoOption.this);
                        //정준
                        //통신할 서버의 주소
